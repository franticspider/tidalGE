...
public class ParserServlet extends HttpServlet {
  ...
  public ParserServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        action = "pull";
        /** Now do any necessary parsing actions */
    
					/** For debugging */
					if(action.equals("push")){
						//As long as we've parsed ok, then we've done fine
						System.out.println("OK to push this pattern as is");
					}
					if(action.equals("pull")){
						System.out.println("Creating mutation for pulling up to render now");
						//We need to mutate the input string and return that
					}

		System.out.println("Creating tidalGE");
		tidalGE tge = new tidalGE();
		//TODO: pass the action in here (only set to pull because of a client side problem sans internet )
		
		System.out.println("Entering tidalGE");
		answer = tge.actionOnPattern(pattern,action);
        
        
		System.out.println("Finished with tidalGE");
        
					/** For debugging - make sure that the client can handle both sorts of errors */
			...
			System.out.println("Returned pattern is:\n"+answer);
    	if(answer == null){
    		/** Parse has been unsuccessful */
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  // TODO Auto-generated method stub
        ...
        System.out.println("Inside doPost in ParserServlet, request is:\n"+request.toString());
 }
